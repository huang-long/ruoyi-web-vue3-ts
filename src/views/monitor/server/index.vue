                ...
                <tr>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div
                      ...
                      class="cell"
                      :class="{
                        'text-danger': server.mem.usage && server.mem.usage > 80,
                      }"
                    >
                      {{ server.mem.usage }}%
                    </div>
                  ...
                  <td class="el-table__cell is-leaf">
                    <div
                      ...
                      class="cell"
                      :class="{
                        'text-danger': server.jvm.usage && server.jvm.usage > 80,
                      }"
                    >
                      {{ server.jvm.usage }}%
                    </div>
                ...
                <tr v-for="(sysFile, index) in server.sysFiles" :key="index">
                  ...
                  <td class="el-table__cell is-leaf">
                    <div
                      class="cell"
                      :class="{
                        'text-danger': sysFile.usage && sysFile.usage > 80,
                      }"
                    >
                      {{ sysFile.usage }}%
                    </div>
...
<script lang="ts" setup name="ServerPage">
import { getServer, type ServerObj } from "@/api/monitor/server";
...
function getList() {
  ...
  getServer().then((response) => {
    response.data && (server.value = response.data);
    load.close();
  });
}
